...
.331, $X_2$ equal the number between .331 and .820, and $X_3$ equal the number greater than .820.
   ...
   a. Calculate, using, R the probability of observing $X_1 = 354, X_2 = 492, X_3 = 192$. Be sure to show your code. State the joint distribution before launching into calculations. 
