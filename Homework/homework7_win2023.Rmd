...
2. A type of metal bar breaks when a force of size $X$ is applied, where $X$ has PDF
...
3. A sample of 83 observations for an integer-valued random variable $Y$ is shown below:
\begin{table}[h]
\centering
...
\end{table}
   ...
   Use the Central Limit Theorem to find a 90% confidence interval for $\pi_0 = P(Y \geq 2)$. 
